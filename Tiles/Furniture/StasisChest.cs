...
using RunesMod.Items.Placeables.Furniture;

namespace RunesMod.Tiles.Furniture
{
    public class StasisChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            Main.tileOreFinderPriority[Type] = 500 + 10;
            ...
            RegisterItemDrop(ModContent.ItemType<StasisChestItem>());
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<StasisChestItem>();
