...
namespace RunesMod.Projectiles.Magic.Elements.Water
{
    public class WaterSpit : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.MagicSchool().Add<WaterMagic>();
        }

        public override void AI()
        {
            float brightness = Math.Clamp(Projectile.velocity.Length(), 0f, 1f);
            Lighting.AddLight(Projectile.Center, 0f, 0.2f * brightness, 0.55f * brightness);
        ...
        Color StripColors(float progressOnStrip)
        {
            ...
            Color result = Color.Lerp(new Color(0, 2, 66), new Color(45, 100, 255), amount) * factor;
