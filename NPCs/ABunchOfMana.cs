...
{
    public class ABunchOfMana : ModNPC
    {
        public override void SetStaticDefaults()
        {
            var drawNPC = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
            {
                CustomTexturePath = "RunesMod/Assets/Textures/Bestiary/ABunchOfMana",
        ...
        {
            Dust dust;
            dust = Dust.NewDustPerfect(NPC.Center, 267, new Vector2(0f, 0f), 0, new Color(0, 0, 255), 1.45f);
            dust.noGravity = true;
        }
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Materials.ManaMatter>(), 1, 1, 3));
        }
    }
}